...
function Camera(props) {
  ...
  return(
    <div className="h-24 my-2 bg-gray-600 flex justify-between items-center">
      <h2 className="text-white font-main text-xl pl-2">Camera Name</h2>
      <span className="h-full flex items-center">
        { status.motion && <FaWalking  className="fill-white h-12 w-12"/> }
        { status.sound && <BsEar className="fill-white h-12 w-12"/> }
